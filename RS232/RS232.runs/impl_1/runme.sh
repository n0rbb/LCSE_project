...
HD_PWD='C:/Users/worbb/Desktop/Electronics/LCSE/RS232/RS232.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nexys_RS232.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nexys_RS232.tcl -notrace
