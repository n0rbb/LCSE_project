...
HD_PWD='C:/Users/worbb/Desktop/Electronics/LCSE/PIC_2/PIC_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nexys_PIC.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nexys_PIC.tcl -notrace
