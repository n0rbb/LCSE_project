...
constant W5  : std_logic_vector(11 downto 0) :=X"0" & TYPE_2 & JMP_UNCOND; --Aquí no necesitamos un 1 ya
...
-- W9 when X"009",
-- W10 when X"00A",
 W11 when X"00B", --Aquí termina toda la parte de la escritura de x00 en NINST
 W12 when X"00C",
 W13 when X"00D",
 W14 when X"00E",
 W15 when X"00F",
