...
HD_PWD='C:/Users/worbb/Desktop/Electronics/LCSE/PIC/PIC.runs/clk_ip_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log clk_ip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source clk_ip.tcl
