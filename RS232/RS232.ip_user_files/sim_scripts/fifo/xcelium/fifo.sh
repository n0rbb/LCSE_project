...
#
# Script generated by Vivado on Sun Oct 13 16:54:07 +0100 2024
...
#
# Usage        : fifo.sh
#                fifo.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                fifo.sh [-reset_run]
#                fifo.sh [-reset_log]
#                fifo.sh [-help]
#
...
#                script (type 'fifo.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname fifo_generator_v13_2_10 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm fifo_generator_v13_2_10 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "fifo.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./fifo.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvlog -work fifo_generator_v13_2_10 $xmvlog_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.fifo xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.fifo -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log fifo_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
Usage: fifo.sh [-reset_log]\n\
Usage: fifo.sh [-keep_index]\n\
