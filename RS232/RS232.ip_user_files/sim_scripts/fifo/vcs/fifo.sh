...
design_libs=(xpm fifo_generator_v13_2_10 xil_defaultlib)
...
compile()
{
  ...
  vlogan -work fifo_generator_v13_2_10 $vlogan_opts +v2k \
...
reset_run()
{
  files_to_remove=(ucli.key fifo_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc fifo_simv.daidir vcs_lib c.obj)
